...
namespace Bitrix24RestApiClient.Test.Tests.RequestBodyTests
{
    ...
    {
        [Theory]
        [JsonFileData("TestData\\deal.json", "ListTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\deal.json", "GetTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\deal.json", "DeleteTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\deal.json", "UpdateTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\deal.json", "AddTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\deal.json", "UpdateWithPhonesAndEmailsTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\deal.json", "AddWithPhonesAndEmailsTest")]
