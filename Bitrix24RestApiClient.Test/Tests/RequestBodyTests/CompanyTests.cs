...
namespace Bitrix24RestApiClient.Test.Tests.RequestBodyTests
{
    public class CompanyTests : IDisposable
    {
        ...
        [Theory]
        [JsonFileData("TestData\\company.json", "GetTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\company.json", "DeleteTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\company.json", "UpdateTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\company.json", "AddTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\company.json", "UpdateWithPhonesAndEmailsTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\company.json", "AddWithPhonesAndEmailsTest")]
