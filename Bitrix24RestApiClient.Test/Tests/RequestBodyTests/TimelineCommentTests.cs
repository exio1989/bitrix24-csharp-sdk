...
namespace Bitrix24RestApiClient.Test.Tests.RequestBodyTests
{
    ...
    {
        [Theory]
        [JsonFileData("TestData\\timeline-comment.json", "ListTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\timeline-comment.json", "GetTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\timeline-comment.json", "DeleteTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\timeline-comment.json", "UpdateTest")]
        ...
        [Theory]
        [JsonFileData("TestData\\timeline-comment.json", "AddTest")]
