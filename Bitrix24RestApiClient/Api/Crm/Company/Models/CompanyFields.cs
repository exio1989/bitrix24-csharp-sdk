namespace Bitrix24ApiClient.src.Models
{
    public static class CompanyFields
    {
        ...
        public const string RegAddressRegion = "REG_ADDRESS_REGION";
        public const string RegAddressProvince = "REG_ADDRESS_PROVINCE";
        public const string RegAddressPostalCode = "REG_ADDRESS_POSTAL_CODE";
        public const string RegAddressCountryCode = "REG_ADDRESS_COUNTRY_CODE";
        public const string RegAddressCountry = "REG_ADDRESS_COUNTRY";
        public const string RegAddressCity = "REG_ADDRESS_CITY";
        public const string RegAddress2 = "REG_ADDRESS_2";
        public const string RegAddress = "REG_ADDRESS";
        public const string RegAddressLegal = "REG_ADDRESS_LEGAL";
        public const string OriginVersion = "ORIGIN_VERSION";
        ...
        public const string IsMyCompany = "IS_MY_COMPANY";
        public const string Industry = "INDUSTRY";
        public const string Im = "IM";
        public const string AddressRegion = "ADDRESS_REGION";
        public const string AddressProvince = "ADDRESS_PROVINCE";
        public const string AddressPostalCode = "ADDRESS_POSTAL_CODE";
        public const string AddressCountryCode = "ADDRESS_COUNTRY_CODE";
        ...
        public const string AddressLegal = "ADDRESS_LEGAL";
        public const string HasPhone = "HAS_PHONE";
